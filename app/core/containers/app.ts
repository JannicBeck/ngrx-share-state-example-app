  ...
  template: `
    <bc-layout>
      ...
      <bc-toolbar (openMenu)="openSidenav()">
        Book Collection opened: {{(counter$ | async)?.countOpened}} closed: {{(counter$ | async)?.countClosed}}
        <button md-button (click)="incrementCounter()">
...
export class AppComponent {
  counter$: Observable<fromCounter.State>;
  ...
  constructor(private store: Store<fromRoot.State>) {
    ...
    this.counter$ = this.store.select(fromRoot.getCounter);
